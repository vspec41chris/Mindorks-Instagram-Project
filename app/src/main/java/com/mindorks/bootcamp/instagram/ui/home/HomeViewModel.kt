...
class HomeViewModel(
    ...
    val launchAppInfo: MutableLiveData<Event<Unit>> = MutableLiveData()
    ...
    fun onAppInfoClick() = launchAppInfo.postValue(Event(Unit))
    ...
    // Checking if loading new data -> if not call load more post
    fun onLoadMore() {
